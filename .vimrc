...
iabbr db debugger<Esc>:w<cr>
iabbr dv - debugger<Esc>:w<cr>

iabbr logi Rails.logger.info
iabbr loge Rails.logger.error
iabbr logw Rails.logger.warn

" Saves time by mapping the spacebar to colon
map <space> :
